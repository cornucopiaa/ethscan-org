...
func Eth1Deposits(w http.ResponseWriter, r *http.Request) {
	...
	data := InitPageData(w, r, "eth1Deposits", "/validators/eth1/deposits", "Eth1 Deposits")
	data.HeaderAd = true
	data.Data = pageData
...
func Eth1DepositsLeaderboard(w http.ResponseWriter, r *http.Request) {
	...
	data := InitPageData(w, r, "eth1Deposits", "/validators/eth1/leaderboard", "Eth1 Deposits Leaderboard")
	data.HeaderAd = true
